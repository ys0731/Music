	    ...
	    <div id="container">
	        <div class="center">
	            <ul class="chart_btn clear">
	                ...
	                <li class="active"><a href="/music/chart/chart_weekly.do">주간</a></li>
	                ...
	                <table>
	                    ...
	                    <tr>
	                		...
	                		<td class="clear">
	                 			...
	                 			<p class="list_title" id="title" class="title">${vo.title }</p>
	                		</td>
	                		<td>
	                		...
	                		<td>
	                			<a class="like_btn like <c:if test="${vo.mlike_cnt==1 }">on</c:if>" href="#" data-no="${vo.no }"></a>  <!-- 좋아요 버튼 -->
	                   		</td>
	                  		<td>
