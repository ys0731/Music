...
<body>
    ...
    <div id="container">
        <div class="center">
            ...
            <form class="form_qna" name="frm" id="frm" action="update.do" method="post" onsubmit="return goSave();">
                <table class="tbl_qna" name="tbl">
                    ...
                    <tr>
                        ...
                        <td>
                           <input type="radio" class="chk_open" name="secret" id="open" value="0" <c:if test="${vo.secret == 0 }">checked</c:if> ><label for="open">전체 공개</label>
                           <input type="radio" class="chk_open" name="secret" id="close" value="1" <c:if test="${vo.secret == 1 }">checked</c:if>><label for="close">비공개</label>
                        </td>
                    </tr>
                    <tr>
                        <td class="notice_regi_title" style="width: 100;"><label for="content">내용</label></td>
                        <td><textarea name="content" id="content" cols="30" rows="10">${vo.content}</textarea></td>
                    </tr>
                </table>
