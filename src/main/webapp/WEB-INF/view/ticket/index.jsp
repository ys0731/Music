        ...
        <div class="center">
            ...
            <div class="ticket_box">
                ...
                <div class="price_box1">                    
                    ...
                    <a <c:if test="${empty userInfo}"> href='javascript:alert("로그인 후 이용해주세요.");' </c:if>
                    <c:if test="${!empty userInfo}"> href='javascript:iamport("${vo.ticket_type}",${vo.price}, ${vo.time},${vo.no});' </c:if> >구매</a>
                </div>
